...
import com.roomorama.caldroid.utils.Constants;
...
public class CaldroidFragment extends DialogFragment {
    ...
    protected void refreshMonthTitleTextView() {
        ...
        String lid = sharedPref.getString(Constants.LANGUAGES_IDS,"");
       if ( Integer.parseInt(lid)==Constants.LANGUAGE_ID_AR)
       {
           monthTitleTextView.setText(getMonthInArabic(monthTitle));
       }
        else
            monthTitleTextView.setText(monthTitle.toUpperCase(Locale.getDefault()));
    }
    public  String getMonthInArabic (String monthTitle)
    {
        String [] months = Constants.ARABIC_MONTHS;
        int position = getMonthPosition(monthTitle);
        String arabicMonth = months[position];
        return getArabicMonthTitle(monthTitle, arabicMonth);

    }
    public static int getMonthPosition (String monthTitle)
    {
        monthTitle = monthTitle.toLowerCase();
        if (monthTitle.contains("january"))
            return 0;
        else if (monthTitle.contains("february"))
            return 1;
        else if (monthTitle.contains("march"))
            return 2;
        else if (monthTitle.contains("april"))
            return 3;
        else if (monthTitle.contains("may"))
            return 4;
        else if (monthTitle.contains("june"))
            return 5;
        else if (monthTitle.contains("july"))
            return 6;
        else if (monthTitle.contains("aug"))
            return 7;
        else if (monthTitle.contains("sep"))
            return 8;
        else if (monthTitle.contains("oct"))
            return 9;
        else if (monthTitle.contains("nov"))
            return 10;
        else if (monthTitle.contains("dec"))
            return 11;
        else
            return 0;
    ...
    public static String  getArabicMonthTitle(String monthTitle, String arabicMonth)
    {
        monthTitle = monthTitle.toLowerCase();
        if (monthTitle.contains("january"))
            return monthTitle.replace("january", arabicMonth);
        else if (monthTitle.contains("february"))
            return monthTitle.replace("february", arabicMonth);
        else if (monthTitle.contains("march"))
            return monthTitle.replace("march", arabicMonth);
        else if (monthTitle.contains("april"))
            return monthTitle.replace("april", arabicMonth);
        else if (monthTitle.contains("may"))
            return monthTitle.replace("may", arabicMonth);
        else if (monthTitle.contains("june"))
            return monthTitle.replace("june", arabicMonth);
        else if (monthTitle.contains("july"))
            return monthTitle.replace("july", arabicMonth);
        else if (monthTitle.contains("august"))
            return monthTitle.replace("august", arabicMonth);
        else if (monthTitle.contains("september"))
            return monthTitle.replace("september", arabicMonth);
        else if (monthTitle.contains("october"))
            return monthTitle.replace("october", arabicMonth);
        else if (monthTitle.contains("november"))
            return monthTitle.replace("november", arabicMonth);
        else if (monthTitle.contains("december"))
            return monthTitle.replace("december", arabicMonth);
        else
            return "";
