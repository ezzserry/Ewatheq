...
import ewatheq.ocr.lib.camera.CameraManager;
import ewatheq.ocr.lib.camera.ShutterButton;
import ewatheq.ocr.lib.language.LanguageCodeHelper;
import ewatheq.ocr.lib.language.TranslateAsyncTask;
import ae.ewatheq.lib.R;
/**
 * This activity opens the camera and does the actual scanning on a ocr_background thread. It draws a
...
ShutterButton.OnShutterButtonListener {
	...
	private void initCamera(SurfaceHolder surfaceHolder) {
		...
		try {
			...
			ioe.printStackTrace();
			Log.e("","Camera Error :" + ioe.getMessage());
