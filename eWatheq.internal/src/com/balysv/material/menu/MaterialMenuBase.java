...
public abstract class MaterialMenuBase implements MaterialMenu {
    ...
    /**
     * Overwrites behaviour of pressed state circle animation even when using {@link #animatePressedState(com.balysv.material.menu.MaterialMenuDrawable.IconState)}
     *
