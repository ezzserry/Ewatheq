...
public class SettingsFragment extends Fragment implements OnClickListener {
    ...
    public void showUserQouta() {
        ...
        String sRatio = String.format("%.1f", longUsedQouta) + usedQuotaUnit + " / " + String.format("%.1f", longTotalQouta) + TotalQuotaUnit;
        tvQouta.setText(sRatio);
        int iRatio= (int) longUsedQouta;
//        int ratio = (int) ((longUsedQouta / longTotalQouta) * 100);

        pbQouta.setProgress(iRatio);
    }
